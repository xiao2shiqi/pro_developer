...
2. 通过流程引擎，可以以极低的成本，快速实现业务工作流，提高开发效率，而且久经生产考验的流程引擎，也比任何人从 0 开始写流程要可靠的多
3. 流程引擎的功能并没有多特别，都可以通过逻辑代码实现的，流程引擎的核心功能在于高质量的复用，设计层面的解耦（设计思想，语言和技术栈无关）
4. BPMN2.0 是行业规范，遵循行业标准，有众多成熟工具可以使用，例如 bpmn 流程设计工具等等……系统需要实现的工作流越多，使用工作流的收益就越大
